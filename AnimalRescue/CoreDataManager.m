...
- (NSManagedObjectModel *)model
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"GameData" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)coordinator
{
    ...
    NSURL *storeURL = [[self storeDirectory] URLByAppendingPathComponent:@"GameData.sqlite"];
