...
-(void)setupButtons
{
    ...
    _button1.assignButton = kbutton1;
    _button2.assignButton = kbutton2;
    _button3.assignButton = kbutton3;
    _button4.assignButton = kbutton4;
    _button5.assignButton = kbutton5;
...
if ([[NSUserDefaults standardUserDefaults] boolForKey:@"Boom"])        [self addChild:_skill10.menuItemFont];
        ...
        CCMenu *menu = [CCMenu menuWithItems:backButton, _skill1, _skill2, _skill3, _skill4, _skill5, _skill6, _skill7, _skill8, _skill9, _skill11, nil];
        menu.position = CGPointZero;
        [self addChild:menu];
if ([[NSUserDefaults standardUserDefaults] boolForKey:@"Boom"])        [menu addChild:_skill10];
...
-(void)TwoCloneShooter:(id)sender
{
    ...
    [self runMenu:sender SkillType:kSkillTwoCloneShooter1];
}

-(void)SideSpreading:(id)sender
{
    [self runMenu:sender SkillType:kSkillSideSpreading1];
}

-(void)Defense:(id)sender
{
    [self runMenu:sender SkillType:kSkillDefenseWall1];
}
...
{
    [self runMenu:sender SkillType:kSkillBoomerang];
}
